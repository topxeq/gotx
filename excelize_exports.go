...
func init() {
	GotxSymbols["github.com/360EntSecGroup-Skylar/excelize"] = map[string]reflect.Value{
		...
		"DataValidationOperatorBetween":                reflect.ValueOf(excelize.DataValidationOperatorBetween),
		"DataValidationOperatorEqual":                  reflect.ValueOf(excelize.DataValidationOperatorEqual),
		"DataValidationOperatorGreaterThan":            reflect.ValueOf(excelize.DataValidationOperatorGreaterThan),
		"DataValidationOperatorGreaterThanOrEqual":     reflect.ValueOf(excelize.DataValidationOperatorGreaterThanOrEqual),
		"DataValidationOperatorLessThan":               reflect.ValueOf(excelize.DataValidationOperatorLessThan),
		"DataValidationOperatorLessThanOrEqual":        reflect.ValueOf(excelize.DataValidationOperatorLessThanOrEqual),
		"DataValidationOperatorNotBetween":             reflect.ValueOf(excelize.DataValidationOperatorNotBetween),
		"DataValidationOperatorNotEqual":               reflect.ValueOf(excelize.DataValidationOperatorNotEqual),
		"DataValidationTypeCustom":                     reflect.ValueOf(excelize.DataValidationTypeCustom),
		"DataValidationTypeDate":                       reflect.ValueOf(excelize.DataValidationTypeDate),
		"DataValidationTypeDecimal":                    reflect.ValueOf(excelize.DataValidationTypeDecimal),
		"DataValidationTypeTextLeng":                   reflect.ValueOf(excelize.DataValidationTypeTextLeng),
		"DataValidationTypeTime":                       reflect.ValueOf(excelize.DataValidationTypeTime),
		"DataValidationTypeWhole":                      reflect.ValueOf(excelize.DataValidationTypeWhole),
